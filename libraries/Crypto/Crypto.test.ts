...
describe("Crypto.default.signMessageWithKey", () => {
    ...
    test("1", () => {
        let param1: any = new Uint8Array([])
        let result: any = inst.signMessageWithKey(param1, "Wait time out reached, while waiting for results")
        expect(result).toMatchSnapshot()
    })
    ...
    test("3", () => {
        let param1: any = new Uint8Array([])
        let result: any = inst.signMessageWithKey(param1, "Missing FileUri configuration")
        expect(result).toMatchSnapshot()
    })
...
describe("Crypto.default.signMessage", () => {
    ...
    test("3", () => {
        let result: any = inst.signMessage("Top level object in 'override.yml' needs to be an object")
        expect(result).toMatchSnapshot()
    })
