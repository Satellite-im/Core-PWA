...
describe("SearchQuery.default.appendCommand", () => {
    ...
    test("0", () => {
        let result: any = inst2.appendCommand(search.SearchCommand.During, "Dillenberg")
        expect(result).toMatchSnapshot()
    })

    test("1", () => {
        let result: any = inst.appendCommand(search.SearchCommand.In, "elio@example.com")
        expect(result).toMatchSnapshot()
    })
    ...
    test("3", () => {
        let result: any = inst4.appendCommand(search.SearchCommand.During, "elio@example.com")
        expect(result).toMatchSnapshot()
    })
...
describe("SearchQuery.default.insertCommand", () => {
    ...
    test("1", () => {
        let result: any = inst.insertCommand(search.SearchCommand.Mentions, "Dillenberg", 1)
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result: any = inst3.insertCommand(search.SearchCommand.Mentions, "Elio", 1)
        expect(result).toMatchSnapshot()
    })

    test("3", () => {
        let result: any = inst4.insertCommand(search.SearchCommand.Empty, "elio@example.com", 1)
        expect(result).toMatchSnapshot()
    })

    test("4", () => {
        let result: any = inst5.insertCommand(search.SearchCommand.During, "Dillenberg", 1.0)
        expect(result).toMatchSnapshot()
    })

    test("5", () => {
        let result: any = inst8.insertCommand(search.SearchCommand.During, "", Infinity)
        expect(result).toMatchSnapshot()
    })
})
...
describe("SearchQuery.default.setQuery", () => {
    ...
    test("1", () => {
        let result: any = inst.setQuery("UPDATE Projects SET pname = %s WHERE pid = %s", 2)
        expect(result).toMatchSnapshot()
    })
...
describe.skip("SearchQuery.default.setQueryByHTML", () => {
    ...
    test("0", () => {
        let result: any = inst2.setQueryByHTML(document.querySelector("canvas:first-of-type","span:first-of-type","div:first-of-type"))
        expect(result).toMatchSnapshot()
    })
}) // AP-780
...
describe("SearchQuery.default.caretPosition", () => {
    ...
    test("0", () => {
        let result: any = inst2.caretPosition(document.querySelector("canvas:first-of-type","span:first-of-type","div:first-of-type"))
        expect(result).toMatchSnapshot()
    })
})
...
describe("SearchQuery.default._parseQuery", () => {
    ...
    test("1", () => {
        let result: any = inst._parseQuery("DELETE FROM Projects WHERE pid = %s\\u0020UPDATE Projects SET pname = %s WHERE pid = %s", 7)
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result: any = inst3._parseQuery("DELETE FROM Projects WHERE pid = %s\\u0020\\u0020UPDATE Projects SET pname = %s WHERE pid = %s", 0)
        expect(result).toMatchSnapshot()
    })

    test("3", () => {
        let result: any = inst4._parseQuery("UPDATE Projects SET pname = %s WHERE pid = %s\\u0020", 1.0)
        expect(result).toMatchSnapshot()
    })
