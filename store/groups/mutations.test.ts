...
describe('misc', () => {
  test('mutations.default.setGroups', () => {
    const localState = { ...GroupsInitialState }
    const argument = [
      {
        id: 'e778d67a-7c14-4592-9513-09cb295b70ea',
        name: 'Pearline Willms',
        admin: 'magni',
        creator:
          'Porro perspiciatis dolorem quasi. Sint sint omnis. Velit nulla sunt cupiditate ea.',
        members: [
          {
            name: 'Garnet Hintz V',
            photoHash:
              'Quia quas repellendus quos delectus aut illo nesciunt neque atque. Ut aut enim harum cumque sunt quam et. Quae sint ut fuga debitis dolore dicta et eum. Natus mollitia odio nemo dolor deleniti cumque voluptates ipsam qui. Qui dolore est aut consectetur et. Ipsum aut accusantium eligendi sit voluptatum et suscipit sunt.',
            status:
              'Nihil similique unde ducimus est dolor commodi repellat quo recusandae. Voluptas qui sed praesentium velit reiciendis voluptas reiciendis qui id. Itaque et ut.\n \rVel nihil quis saepe dolor corrupti itaque accusantium quis. Nihil illum incidunt rerum autem. Qui omnis repellat quod dignissimos iure qui.\n \rAb ad hic iusto hic magnam vitae. Debitis tenetur quia corrupti vel distinctio enim. Id assumenda aut. Quia odit veritatis suscipit minima. Tenetur nemo debitis officiis. Saepe minus sed.',
            address:
              'Delectus numquam vel minus iste iste unde natus.\nEt beatae provident commodi voluptas qui illum est aliquid atque.\nPariatur distinctio excepturi adipisci ab saepe.',
          },
          {
            name: 'Emerson Nader',
            photoHash: 'quasi',
            status:
              'Magni quisquam aut et numquam quod sed.\nQuas exercitationem quia dolores nihil dolor fugiat alias et.\nQui quis rerum ducimus voluptates.',
            address:
              'Unde velit ea esse cumque. Sit velit et accusantium sapiente.',
          },
        ],
        addresses: ['in possimus molestiae'],
        openInvites: true,
        encryptionKey: 'Ut illo expedita fuga.',
        lastUpdate: 93069,
      },
    ]
  ...
  test('mutations.default.addGroupSubscription', () => {
    const localState = { ...GroupsInitialState }
    const argument = 'string'
    mutations.default.addGroupSubscription(localState, argument)
    expect(localState.groupSubscriptions).toContain(argument)
  })
})
