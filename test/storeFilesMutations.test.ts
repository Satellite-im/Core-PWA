...
describe("mutations.default.fetchFiles", () => {
    test("0", () => {
        ...
        let object3: any = [{ name: "Anas", modified: 400, type: "string", size: 32, location: "ponicode.com", meta: { liked: true, shared: false } }, { name: "Edmond", modified: 500, type: "number", size: 32, location: "ponicode.com", meta: { liked: true, shared: false } }]
    ...
    test("1", () => {
        let object: any = [{ name: "Jean-Philippe", modified: 400, type: "array", size: 10, location: "https://croplands.org/app/a/confirm?t=", meta: { liked: false, shared: true } }, { name: "Pierre Edouard", modified: 500, type: "string", size: 256, location: "ponicode.com", meta: { liked: false, shared: true } }, { name: "Pierre Edouard", modified: 404, type: "number", size: 64, location: "http://base.com", meta: { liked: true, shared: true } }]
        ...
        let object7: any = [{ name: "Pierre Edouard", modified: 500, type: "number", size: 256, location: "ponicode.com", meta: { liked: true, shared: true } }, { name: "Pierre Edouard", modified: 429, type: "string", size: 256, location: "www.google.com", meta: { liked: true, shared: false } }, { name: "Edmond", modified: 404, type: "array", size: 32, location: "ponicode.com", meta: { liked: false, shared: true } }, { name: "Michael", modified: 200, type: "array", size: 32, location: "ponicode.com", meta: { liked: true, shared: false } }, { name: "Michael", modified: 400, type: "number", size: 256, location: "http://www.example.com/route/123?foo=bar", meta: { liked: true, shared: true } }]
